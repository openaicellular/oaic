...
#ifndef	_E2SM_KPM_EPC_DU_PM_Container_H_
#define	_E2SM_KPM_EPC_DU_PM_Container_H_
...
typedef struct E2SM_KPM_EPC_DU_PM_Container {
	struct E2SM_KPM_EPC_DU_PM_Container__perQCIReportList {
		A_SEQUENCE_OF(struct E2SM_KPM_PerQCIReportListItem) list;
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} E2SM_KPM_EPC_DU_PM_Container_t;
...
#endif	/* _E2SM_KPM_EPC_DU_PM_Container_H_ */
