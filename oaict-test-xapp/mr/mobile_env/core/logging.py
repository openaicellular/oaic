...
class Monitor:
    ...
    def load_results(self):
        ...
        print('scalar_results=', scalar_results)
        scalar_results.index.names = ["Time Step"]
        print('scalar_results.index.names=', scalar_results)
...
#         print('ue_results=', ue_results)
#         print('ue_results.index=', ue_results.index)
...
#         print('bs_results=', bs_results)
#         #bs_results.index.names = {"Metric": "BS ID"}
#         #print('bs_results.index.names=', bs_results)
#         # change data frame format to align time axis along rows
...
#         bs_results = bs_results.unstack()
        ...
        return scalar_results #, bs_results #,ue_results 
