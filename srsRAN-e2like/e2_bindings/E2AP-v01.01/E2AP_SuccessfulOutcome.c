...
static asn_TYPE_member_t asn_MBR_E2AP_value_4[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E2AP_SuccessfulOutcome__value, choice.E2nodeConfigurationUpdateAcknowledge),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E2AP_E2nodeConfigurationUpdateAcknowledge,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"E2nodeConfigurationUpdateAcknowledge"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct E2AP_SuccessfulOutcome__value, choice.E2connectionUpdateAcknowledge),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E2AP_E2connectionUpdateAcknowledge,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
