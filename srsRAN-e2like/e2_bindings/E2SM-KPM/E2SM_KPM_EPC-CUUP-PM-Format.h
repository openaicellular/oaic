...
#ifndef	_E2SM_KPM_EPC_CUUP_PM_Format_H_
#define	_E2SM_KPM_EPC_CUUP_PM_Format_H_
...
typedef struct E2SM_KPM_EPC_CUUP_PM_Format {
	struct E2SM_KPM_EPC_CUUP_PM_Format__perQCIReportList {
		A_SEQUENCE_OF(struct E2SM_KPM_PerQCIReportListItemFormat) list;
...
#endif	/* _E2SM_KPM_EPC_CUUP_PM_Format_H_ */
