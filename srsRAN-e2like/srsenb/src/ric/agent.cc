			   ...
			   int flags)
{
  ...
  // Changes to get bitrate
  // srsenb::enb_metrics_t enb_metrics = {};
  // enb_metrics_interface->get_metrics(&enb_metrics);
  ...
  // }
  // float bitrate = ul_rate_sum;
  
  // RIC_INFO("Bitrate: %f\n", bitrate);
  // send_sctp_data(static_cast<uint8_t*>(static_cast<void*>(&bitrate)), 4);
